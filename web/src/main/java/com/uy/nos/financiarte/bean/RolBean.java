...
import com.uy.nos.financiarte.controller.RegistroRol;
...
public class RolBean {
	...
	public void onEdit(RowEditEvent event) {  
            ...
            try {
				...
				FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_INFO, "Se modificó ", rol.getRol());  
	            FacesContext.getCurrentInstance().addMessage(null, msg); 
			} catch (Exception e) {
				FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_INFO, "Error al modificar ", rol.getRol());  
	            FacesContext.getCurrentInstance().addMessage(null, msg); 
			}
    }

...
@Path("/transacciones")
@RequestScoped
public class TransaccionResourceRESTService {
	
   @Inject
   private EntityManager em;
   
   @Inject
   private TransaccionListProducer transacciones;
   ...
   public List<Transaccion> listAll() {
      ...
      final List<Transaccion> results = transacciones.getTransacciones();
      return results;
   }
   ...
   @Path("/{id:[0-9][0-9]*}")
   @Produces("application/json")
   public Transaccion lookupById(@PathParam("id") long id) {

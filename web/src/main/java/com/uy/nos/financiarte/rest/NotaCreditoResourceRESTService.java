...
@Path("/notasCredito")
@RequestScoped
public class NotaCreditoResourceRESTService {
	
   @Inject
   private EntityManager em;
   
   @Inject
   private NotaCreditoListProducer notasCredito;
   ...
   public List<NotaCredito> listAll() {
      ...
      final List<NotaCredito> results = notasCredito.getNotasCredito();
      return results;
   }
   ...
   @Path("/{id:[0-9][0-9]*}")
   @Produces("application/json")
   public NotaCredito lookupById(@PathParam("id") long id) {
